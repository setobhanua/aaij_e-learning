                                ...
                                <div class="row" style="margin:30px 0 70px 0;">
									<div class="col-sm-3">
											...
											<div style="width:90%; text-align:center;">
												<a href="sic.php?plh=plh">
												<img src="assets/icn/communication.png" width="80%">
											</div> 
											</a><br>
                                            <strong>Eksternal Sharing</strong>
											</center><br><br>
									</div>
									...
									<div class="col-sm-3">
											<center>
											<div style="width:90%; text-align:center;">
												<a href="sic2.php?plh=plh">
												<img src="assets/icn/conversation.png" width="80%">
											</div> 
											</a><br>

<?php
    ...
    if(!empty($_POST)){
        ...
        $sql = "INSERT INTO el_module (golongan, title, description, thumbnail, closed, created_at)
                VALUES ('".$data['golongan']."','".$data['title']."','".$data['description']."','$target_file','".$data['date']."',GETDATE())";
                            ...
                            <div class="card strpied-tabled-with-hover" style="padding: 10px 20px;">
                                <div class="card-header ">
                                    <div class="float-left">
                                        ...
                                        <p class="card-category">Add Module Wajib</p>
                                    </div>
                                </div>
    ...
    function addRow(){
        ...
        var html = '<div id="row'+id+'">\
                        ...
                        <div class="form-left-to-w3l">\
                            ...
                            <textarea type="text" name="isi[]"  class="mytextarea form-control"></textarea>\
                            <div class="clear"></div>\
                        </div><br>\
                        <div class="form-left-to-w3l">\

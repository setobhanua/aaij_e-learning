<?php
    ...
    if(!empty($_POST)){
        ...
        $sql = "UPDATE el_video SET title='".$_POST['title']."', description='".$_POST['description']."',
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-left-to-w3l">
                                            ...
                                            <textarea name="description" placeholder="Description" class="form-control mytextarea" <?=$data['description']?>></textarea>
                                            <div class="clear"></div>
                                        </div><br>

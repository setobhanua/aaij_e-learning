<?php
    ...
    if(!empty($_POST)){
        ...
        $sql = "INSERT INTO el_pengumuman (judul, date, [file])
                VALUES ('".$data['judul']."','".$data['date']."','$target_file')";
        ...
        echo "<script>
                alert('".$message."');
                window.location.href='admin_pengumuman.php?adpgmn=adpgmn';
            </script>";
    }
?>
...
<body>
    <div class="wrapper">
        ...
        <?php
        $page = 'admin_pengumuman'; // current page is about, do the same for other page
        $collapsePage = 'menu3';
        include('sidebar.php');
        ?>
        <!-- Include End Sidebar -->
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-left-to-w3l">
                                            <label style="font-weight:900;">Judul</label>
                                        ...
                                        <br>
                                        <a href="admin_pengumuman.php?adpgmn=adpgmn" class="btn btn-info">Kembali</a>

                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card data-tables">
                                    ...
                                    <h3> Pendahuluan
                                    <a margin-right: 30px;> 
                                    <input type="checkbox" name="language[]" value="Pendahuluan" checked="checked" />
                                        <h3> Safety Umum 
                                        <input type="checkbox" name="language[]" value="Pendahuluan" />
                                        <h3> Safety Office 
                                        <input type="checkbox" name="language[]" value="Pendahuluan" />
                                        <h3> Safety Pabrik
                                        <input type="checkbox" style="margin-right:10px"  name="language[]" value="Pendahuluan" checked="checked" disabled="disabled"/>

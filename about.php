                        ...
                        <div class="row" >
                            <div class="col-md-12" >
                                <div class="card data-tables" >
                                    <div class="card-body table-striped table-no-bordered table-hover dataTable"  style="margin:20px 0 50px 0;" >
                                    <center><h3><strong> Tujuan </strong></h3></center><br>
                                    <h5>    Untuk meningkatkan daya serap dari para karyawan atas materi yang diajarkan, meningkatkan partisipasi aktif dari para karyawan, meningkatkan kemampuan belajar mandiri, dan meningkatkan kualitas materi pembelajaran. Diharapkan dapat merangsang pertumbuhan inovasi baru para karyawan sesuai dengan bidangnya masing-masing. Dan memiliki manfaat sebagai berikut <h5>
                                    
                                    <ul> 
                                    <h5>    <li>E-learning memberikan fleksibilitas dalam memilih waktu dan tempat untuk mengakses pelajaran dilakukan dari mana saja.</li>
                                            <li>E-learning memberikan kesempatan bagi pembelajar secara mandiri memegang kendali atas keberhasilan belajarnya.</li>
                                            <li>Memungkinkan terjadinya interaksi pembelajaran dari mana dan kapan saja</li>
                                            <li>Mengurangi biaya perjalanan</li>
                                            <li>Menjangkau peserta didik dalam cakupan yang luas </li>
                                    ...
                                    untuk informasi lebih lanjut silahkan menghubungi admin bagian HRD.
                                    <br>

<?php
    ...
    if(!empty($_GET['id']) && !empty($_GET['do']) && $_GET['do'] = "delete"){
        ...
        echo "<script>
                alert('".$message."');
                window.location.href='admin_module_pilihan.php?mopi=mopi';
            </script>";
    }
                            ...
                            <div class="card strpied-tabled-with-hover" style="padding: 10px 20px;">
                                <div class="card-header">
                                    <div class="float-left">
                                        <h4 class="card-title">Module Pilihan</h4>
                                        <p class="card-category">List of Module Data</p>
                                    </div>
                                    <div class="float-right">
                                        <a href="admin_module_pilihan_create.php" class="btn btn-primary">+ Tambah</a>
                                    </div>
                                </div>
                                            ...
                                            <?php $i=$pagination['start']+1; while($data = sqlsrv_fetch_array($data_module, SQLSRV_FETCH_ASSOC)): ?>
                                                <tr style="cursor:pointer;">
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-danger" style="color:white; width:100px;" href="admin_module_pilihan.php?do=delete&id=<?=$data['id']?>">
    ...
    function addRow(){
        ...
        var html = '<div id="row'+id+'">\
                        ...
                        <div class="form-left-to-w3l">\
                            ...
                            <textarea name="isi[]" id="mytextarea" class="form-control"></textarea>\
                            <div class="clear"></div>\
                        </div><br>\
                        <div class="form-left-to-w3l">\
                            <label style="font-weight:600;">Media</label>\
                            <input type="file" name="image[]" id="mytextarea" class="form-control">\
                            <div class="clear"></div>\
                        </div><br>\

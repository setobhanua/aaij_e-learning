<?php
    ...
    $sql = "SELECT A.*, B.genre FROM el_ebook A
            INNER JOIN el_ebook_genre B ON A.id_genre = B.id
            WHERE A.id=".$_GET['id'];
    ...
    if(!empty($_POST)){
        ...
        $sql = "UPDATE el_ebook SET title='".$_POST['title']."', sinopsis='".$_POST['sinopsis']."',
                                    id_genre='".$_POST['id_genre']."', date='".$_POST['date']."', [file]='$target_file'
                                    WHERE id = ".$_GET['id'];
        $data_book = sqlsrv_query($conn, $sql);
    }
                            ...
                            <div class="card strpied-tabled-with-hover" style="padding: 10px 20px;">
                                <div class="card-header ">
                                    <div class="float-left">
                                        ...
                                        <p class="card-category">Edit book master data</p>
                                    </div>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-left-to-w3l">
                                            ...
                                            <textarea name="sinopsis" placeholder="Synopsis" class="form-control" required><?=$data['sinopsis']?></textarea>
                                            <div class="clear"></div>
                                        </div><br>
                                        ...
                                        <div class="form-left-to-w3l ">
                                            ...
                                            <iframe src="<?=$data['file']?>" style="max-height:200px;"></iframe>
                                        ...
                                        <div class="form-left-to-w3l ">
                                            ...
                                            <select class="form-control" name="id_genre">
                                                <?php while($book_genre = sqlsrv_fetch_array($sql, SQLSRV_FETCH_ASSOC)): ?>
                                                    <option value="<?=$book_genre['id']?>" <?=$book_genre['id']==$data['id_genre']?'selected':''?>><?=$book_genre['genre']?></option>
                                                <?php endwhile; ?>
                                            </select>
                                            <div class="clear"></div>
                                        </div><br>

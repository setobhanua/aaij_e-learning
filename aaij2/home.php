                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                <div class="card data-tables">
                                    ...
                                    <center><img width="100%" src="assets/img/alp.png"></center>
                                    </div>
                                </div>

                                <div class="container">

                                <div class="row" style="margin:30px 0 70px 0;">
									<div class="col-sm-3">
											<center>
											<div style="width:90%; text-align:center;">
												<a href="maaij.php">
												<img src="assets/icn/books.png" width="80%">
											</div> 
											</a><br>
                                            <strong>Module AAIJ</strong>
											</center><br><br>
									</div>
									...
									<div class="col-sm-3">
											<center>
											<div style="width:90%; text-align:center;">
												<a href="sicmenu.php?plh=plh">
												<img src="assets/icn/share.png" width="80%">
											</div> 
											</a><br>
									...
									<div class="col-sm-3">
											...
											<div style="width:90%; text-align:center;">
												<a href="video1.php">
												<img src="assets/icn/video.png" width="80%">
											</div> 
                                            
											</a><br>
                                            <strong>AICast</strong>
											</center><br><br>
									</div>
                                    ...
                                    <div class="col-sm-3">
											...
											<div style="width:90%; text-align:center;">
												<a href="elib.php">
												<img src="assets/icn/library.png" width="80%">
											</div> 
											</a><br>

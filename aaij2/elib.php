                                ...
                                <div class="row" style="margin:30px 0 70px 0;">
									<div class="col-sm-3">
											...
											<div style="width:90%; text-align:center;">
												<a href="library.php?plh=plh">
												<img src="assets/icn/lt3.png" width="80%">
											</div> 
											</a><br>
                                            <strong>Perpustakaan Lantai 3</strong>
											</center><br><br>
									</div>
									...
									<div class="col-sm-3">
											<center>
											<div style="width:90%; text-align:center;">
												<a href="elibrary.php?plh=plh">
												<img src="assets/icn/perpus.png" width="80%">
											</div> 
											</a><br>

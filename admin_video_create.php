<?php
    ...
    if(!empty($_POST)){
        ...
        // $target_file = "assets/uploads/".md5($date).'.'.$filetype[1];
        $target_file = $data['file'];

        $sql = "INSERT INTO el_video (title, description, date, [file])
                VALUES ('".$data['title']."','".$data['description']."','".$data['date']."','$target_file')";
                            ...
                            <div class="card strpied-tabled-with-hover" style="padding: 10px 20px;">
                                <div class="card-header ">
                                    <div class="float-left">
                                        ...
                                        <p class="card-category">Add new video master data</p>
                                    </div>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-left-to-w3l">
                                            ...
                                            <textarea name="description" placeholder="Description" class="form-control mytextarea"></textarea>
                                            <div class="clear"></div>
                                        </div><br>
                                        ...
                                        <div class="form-left-to-w3l ">
                                            <label style="font-weight:900;">Video</label>
                                            <input type="text" name="file" placeholder="Youtube Link" class="form-control" required="">
                                            <div class="clear"></div>
                                        </div><br>

                                        <br>
                                        <a href="admin_video.php" class="btn btn-info">Kembali</a>

<?php
    ...
    if(!empty($_POST)){
        ...
        $data['user_aktif'] = !empty($data['user_aktif']);
        $data['user_admin'] = !empty($data['user_admin']);
        $message = "Berhasil menambahkan data";

        $sql = "INSERT INTO el_user (user_npk, user_nama, user_gol, user_desc_dept, user_desc_sie, user_password, user_aktif, user_admin)
                VALUES ('".$data['user_npk']."','".$data['user_nama']."','".$data['user_gol']."','".$data['user_desc_dept']."','".$data['user_desc_sie']."','".$data['user_password']."','".$data['user_aktif']."','".$data['user_admin']."')";
                            ...
                            <div class="card strpied-tabled-with-hover" style="padding: 10px 20px;">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <div class="form-left-to-w3l">
                                            ...
                                            <input type="number" name="user_npk" placeholder="NPK" class="form-control" required>
                                            <div class="clear"></div>
                                        </div><br>

                                        <div class="form-left-to-w3l">
                                            <label style="font-weight:900;">Nama</label>
                                            <input type="text" name="user_nama" placeholder="Nama" class="form-control" required>
                                            <div class="clear"></div>
                                        </div><br>
                                        ...
                                        <div class="form-left-to-w3l">
                                            ...
                                            <input type="text" name="user_desc_dept" placeholder="Departemen" class="form-control" required>
                                            <div class="clear"></div>
                                        </div><br>

                                        <div class="form-left-to-w3l">
                                            <label style="font-weight:900;">Seksi</label>
                                            <input type="text" name="user_desc_sie" placeholder="Seksi" class="form-control" required>
                                            <div class="clear"></div>
                                        </div><br>
                                        ...
                                        <div class="form-left-to-w3l" style="padding-left:20px;">
                                            <input type="checkbox" name="user_aktif">

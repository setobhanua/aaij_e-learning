								...
								<div class="row" style="margin:20px 0 20px 0;">
                                    ...
                                    ?>
                                        <div style="background:black; width:100%;">
                                            <center style="margin-bottom: -5px;">
                                                <iframe width="100%" height="auto" src="<?=$youtube?>"
                                    ...
                                    <?php if(empty($count)): ?>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM el_video $search ORDER BY id DESC";
                                            ...
                                            // $data_video = sqlsrv_fetch_array($data_video, SQLSRV_FETCH_ASSOC);
                                        ...
                                        <div class="col-md-12">
                                            <ul class="pagination float-right">
                                                <li class="paginate_button page-item <?=$pagination['page']==1?'disabled':''?>">
                                                    <a href="video1.php?<?=!empty($_GET['q'])?"q=$_GET[q]&":''?>page=<?=$pagination['page']!=1?$pagination['page']-1:''?>" class="page-link">Previous</a>
                                                </li>
                                                <?php for($i=$pagination['first'];$i<=$pagination['last'];$i++): ?>
                                                    <li class="paginate_button page-item <?=$pagination['page']==$i?'active':''?>">
                                                        <a href="video1.php?<?=!empty($_GET['q'])?"q=$_GET[q]&":''?>page=<?=$i?>" class="page-link"><?=$i?></a>
                                                    </li>
                                                <?php endfor; ?>
                                                <li class="paginate_button page-item <?=$pagination['page']>=$pagination['total_page']?'disabled':''?>">
                                                    <a href="video1.php?<?=!empty($_GET['q'])?"q=$_GET[q]&":''?>page=<?=$pagination['page']<$pagination['total_page']?$pagination['page']+1:''?>" class="page-link">Next</a>
                                                </li>
                                            </ul>
                                        </div>

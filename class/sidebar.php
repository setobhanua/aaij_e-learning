	...
	<div class="sidebar-wrapper" style='border-right:thin #cccccc solid;'>
		<div class="logo">
			<a href="https://www.akebono-astra.co.id/" class="simple-text logo-normal">
				<center>
					<img style='height:25px;' width="auto" src="../assets/img/logo_akebono3.png">
				</center>
			</a>
		</div>
		...
		<ul class="nav">
			...
			<li class="nav-item <?php if ($collapsePage == 'menu2') {
				...
				<div class="collapse <?php if ($collapsePage == 'menu2') {
					...
					<ul class="nav">
						<!-- Sub Menu2 1 -->
						<!-- <li class="nav-item <?php if ($_GET['input'] == 'input') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../input.php?input=input">
								<span class="sidebar-mini">CI</span>
								<span class="sidebar-normal">Input</span>
							</a>
						</li> -->
						<!-- Sub Menu2 2 -->
						<!-- <li class="nav-item <?php if ($_GET['view'] == 'view') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../view.php?view=view">
								<span class="sidebar-mini">CV</span>
								<span class="sidebar-normal">View</span>
							</a>
						</li> -->
						<!-- Sub Menu2 3 -->
						<li class="nav-item <?php if ($_GET['wjb'] == 'wjb') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="wajib1.php?wjb=wjb">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Kelas Wajib</span>
							</a>
						</li>
						<!-- Sub Menu2 4 -->
						<li class="nav-item <?php if ($_GET['plh'] == 'plh') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="pilihan1.php?plh=plh">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Kelas Pilihan</span>
							</a>
						</li>
						<!-- Sub Menu2 5 -->
						<li class="nav-item <?php if ($_GET['sy'] == 'sy') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="saya.php?sy=sy">
								<span class="sidebar-mini"></span>
		  ...
		  <!-- Profile -->
			...
			<div style="display: <?= admin($status) ?>;">
			<li class="nav-item <?php if ($collapsePage == 'menu3') {
				...
				<div class="collapse<?php if ($collapsePage == 'menu3') {
					...
					<ul class="nav">
						...
						<!-- Sub Menu3 1 -->
						<li class="nav-item <?php if ($_GET['mowa'] == 'mowa') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../admin_module_wajib.php?mowa=mowa">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Modul Wajib</span>
							</a>
						</li>
						

						<!-- Sub Menu3 2 -->
						<li class="nav-item <?php if ($_GET['mopi'] == 'mopi') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../admin_module_pilihan.php?mopi=mopi">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Modul Pilihan</span>
							</a>
						</li>
						...
						<li class="nav-item <?php if ($_GET['sic'] == 'sic' || $page=="admin_sic") {
							...
							<a class="nav-link " href="../admin_sic.php?sic=sic">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Sharing is Caring</span>
							</a>
						</li>
						...
						<!-- Sub Menu3 3 -->
						<li class="nav-item <?php if ($_GET['avi'] == 'avi') {
												echo 'active';
											} ?>">
						...
						<!-- Sub Menu3 4 -->
						<li class="nav-item <?php if ($_GET['adbok'] == 'adbok') {
												echo 'active';
											} ?>">
						...
						<!-- Sub Menu3 5 -->
						<li class="nav-item <?php if ($_GET['prg'] == 'prg') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="#?prg=prg">
								<span class="sidebar-mini"></span>
						...
						<!-- Sub Menu3 6 -->
						<li class="nav-item <?php if ($_GET['kry'] == 'kry') {
												echo 'active';
											} ?>">
						...
						<!-- Sub Menu3 10 -->
						<li class="nav-item <?php if ($_GET['adpgmn'] == 'adpgmn') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../admin_pengumuman.php?adpgmn=adpgmn">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Pengumuman</span>
							</a>
						</li>
						

						<!-- Sub Menu3 8 -->
						<li class="nav-item <?php if ($_GET['adfaq'] == 'adfaq') {
												echo 'active';
											} ?>">
			...
			<li class="nav-item <?php if ($collapsePage == 'menu4') {
				...
				<div class="collapse <?php if ($collapsePage == 'menu4') {
					...
					<ul class="nav">
						...
						<!-- Sub Menu3 7 -->
						<li class="nav-item <?php if ($_GET['pgmn'] == 'pgmn') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../pengumuman.php?pgmn=pgmn">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">Pengumuman</span>
							</a>
						</li>				
						...
						<!-- Sub Menu3 3 -->
						<li class="nav-item <?php if ($_GET['faq'] == 'faq') {
												echo 'active';
											} ?>">
							<a class="nav-link " href="../faq.php?faq=faq">
								<span class="sidebar-mini"></span>
								<span class="sidebar-normal">FAQ</span>
							</a>
						</li>
			...
			<li class="nav-item active" style='margin-top:20px;'>
				<a id="logout-btn" class="nav-link" style='background-color:#2e86de' href="../logout.php">
